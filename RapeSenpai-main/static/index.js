(function(w) {
    ...
    w.shareText = function(score) {
        ...
        SubmitResults();
        if (score <= 49) return '奶奶滴！给我玩阴的是吧！';
        if (score <= 99) return '鸡汤来喽！';
        if (score <= 149) return '我就是大名鼎鼎的重庆军统，大日本双料的高级特工，代号-穿山甲！';
        if (score <= 199) return '我一个催逝员，怎么能喝这鸡汤呢？';
        return '龟野先生，天皇陛下，我的任务完成了！';
    }
    ...
    console.log("DreamsUncle（呵呵）魔改的，毕竟开源了(ˉ▽ˉ；)...");
}) (window);